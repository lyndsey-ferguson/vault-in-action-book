...
mkdir -p /opt/vault/ssl/private
chmod 755 /opt/vault/ssl
...
cat << EOF > /opt/vault/ssl/cert.pem
${acme_cert}
EOF
chown vault:vault /opt/vault/ssl/cert.pem

cat << EOF > /opt/vault/ssl/private/cert.key
${acme_key}
EOF
chown vault:vault /opt/vault/ssl/private/cert.key
...
listener "tcp" {
  ...
  tls_cert_file = "/opt/vault/ssl/cert.pem"
  tls_key_file = "/opt/vault/ssl/private/cert.key"
}
